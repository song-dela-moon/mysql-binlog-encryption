...
| 도메인 | 권장 설정 | 사유 |
| :--- | :---: | :--- |
| **금융 / 의료** | **필수 적용** | 데이터 유출 시 법적/경제적 타격이 막대하므로, 성능을 희생하더라도 서버 자원을 증설하여 암호화를 적용해야 합니다. |
| **커머스 / 결제** | **선별 적용** | 결제 정보 등 민감 데이터가 포함된 DB는 암호화를 적용하되, 일반 상품 정보 DB는 성능을 위해 해제하는 전략이 효율적입니다. |
